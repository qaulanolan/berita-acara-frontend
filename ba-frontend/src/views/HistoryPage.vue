...
/* Kunci 2: Tentukan lebar kolom secara eksplisit */
.history-table th:nth-child(1), .history-table td:nth-child(1) { width: 20%; } /* Kolom Nomor BA */
.history-table th:nth-child(2), .history-table td:nth-child(2) { width: 20%; } /* Kolom Jenis Template */
.history-table th:nth-child(3), .history-table td:nth-child(3) { width: 30%; } /* Kolom Judul Pekerjaan (lebih lebar) */
.history-table th:nth-child(4), .history-table td:nth-child(4) { width: 15%; } /* Kolom Tanggal Generate */
.history-table th:nth-child(5), .history-table td:nth-child(5) { width: 15%; } /* Kolom Aksi */
...
.history-table td {
  ...
  /* Kunci 3: Paksa teks yang panjang untuk dipecah */
